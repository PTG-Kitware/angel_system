...
namespace Cogobyte.ProceduralLibrary
{
    ...
    public class BezierPathArrayEditor : PathArrayEditor
    {
        ...
        private void ShowPoint(int index)
        {
            ...
            Handles.color = Color.green;
            if (Handles.Button(spline.points[index].position, Quaternion.identity, size * handleSize, size * 3 * pickSize, Handles.DotHandleCap))
            {
                selectedIndex = index;
                Repaint();
            }
            if (selectedIndex == index)
            {
                ...
                Handles.CubeHandleCap(17, spline.points[index].frontControlPoint, Quaternion.identity, size * handleSize,EventType.Repaint);
                EditorGUI.BeginChangeCheck();
                ...
                Handles.CubeHandleCap(18, spline.points[index].backControlPoint, Quaternion.identity, size * handleSize,EventType.Repaint);
                EditorGUI.BeginChangeCheck();
