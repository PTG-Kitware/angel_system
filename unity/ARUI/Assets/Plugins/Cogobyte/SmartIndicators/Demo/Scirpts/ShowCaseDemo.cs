...
namespace Cogobyte.Demo.SmartProceduralIndicators
{
    ...
    public class ShowCaseDemo : MonoBehaviour
    {
        public List<GameObject> demos;
        public int currentDemo = 0;
        ...
        public void Start()
        {
            ...
            descriptions[currentDemo].SetActive(true);
        ...
        public void NextDemo()
        {
            ...
            descriptions[currentDemo].SetActive(false);
            currentDemo = (currentDemo + 1) % demos.Count;
            descriptions[currentDemo].SetActive(true);
            demos[currentDemo].SetActive(true);
        ...
        public void PreviousDemo()
        {
            demos[currentDemo].SetActive(false);
            descriptions[currentDemo].SetActive(false);
            currentDemo = (currentDemo - 1 + demos.Count) % demos.Count;
            descriptions[currentDemo].SetActive(true);
            demos[currentDemo].SetActive(true);
        }
