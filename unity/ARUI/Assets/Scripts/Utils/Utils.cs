...
public static class Utils
{
    ...
    /// <summary>
    /// Spawn planes representing the viewfrustum of the camera
    /// https://forum.unity.com/threads/drawing-camera-frustum-with-a-mesh-strange-behaviour.573064/
    /// </summary>
    public static void SpawnViewFrustum()
    {
        GameObject[] Triangles = new GameObject[4];
        for (int i = 0; i < 4; i++)
        {
            GameObject child = new GameObject();
            MeshFilter mf = child.AddComponent<MeshFilter>();
            child.transform.parent = Camera.main.transform;
            Triangles[i] = child;
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            Triangles[i].AddComponent<MeshCollider>();
            Triangles[i].layer = 4;
        }
    }
