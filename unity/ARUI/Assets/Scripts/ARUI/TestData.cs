...
public class TestData : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            AngelARUI.Instance.ShowNotificationmsg(msgCat.N_CAT_NOTICE, msgContext.N_CONTEXT_TASK_ERROR, "We detected that you are about to skip task: ");
        }

        if (Input.GetKeyUp(KeyCode.M))
            AngelARUI.Instance.CloseNotification();
    }
#endif
}
