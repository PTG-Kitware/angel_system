...
FORMAT_STR_REMOVE_LEADING_SEPARATOR = 'call:_colcon_prefix_bat_strip_leading_semicolon "{name}"'
FORMAT_STR_REMOVE_TRAILING_SEPARATOR = 'call:_colcon_prefix_bat_strip_trailing_semicolon "{name}"'
