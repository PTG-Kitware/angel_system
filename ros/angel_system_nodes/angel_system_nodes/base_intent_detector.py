...
class BaseIntentDetector(BaseDialogueSystemNode):
    def __init__(self):
        super().__init__()
    ...
    def publish_msg(self, sub_msg: DialogueUtterance, intent: str, score: float):
        """
        Handles message publishing for an utterance with a detected intent.
        """
        pub_msg = self.copy_dialogue_utterance(sub_msg, node_name="Intent Detection")
        ...
        # Log intent detection information.
