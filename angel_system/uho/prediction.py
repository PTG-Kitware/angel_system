...
def predict(fcn: UnifiedFCNModule,
    ...
    # Build up aux data package for temporal model prediction
    # Items added to this need to have a batch dimension at the front. We are
    # only predicting with a batch size of 1, so most things need an
    # `unsqueeze(0)` when being added to this.
    data = {}
