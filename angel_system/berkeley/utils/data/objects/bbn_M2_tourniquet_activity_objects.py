...
sub_steps['step 9'].append(sub_step)
del sub_step
...
CONTACT_PAIRS = contact_pairs_details = [
    ...
    [['hand', 'tourniquet_tourniquet']], # step 4
    [['hand', 'tourniquet_windlass']], # step 5
    [['hand', 'tourniquet_windlass']], # step 6
    [['hand', 'tourniquet_tourniquet']], # step 7
    [['hand', 'tourniquet_label'],
     ['hand', 'tourniquet_tourniquet']], # step 8
    [['hand', 'tourniquet_pen'],
     ['tourniquet_pen', 'tourniquet_label']] # step 9
]
