...
def get_parser():
    ...
    parser.add_argument(
        ...
        "If not given, will/shared/niudt/detectron2/test_results/kitchen show output in an OpenCV window.",
        required=True
...
if __name__ == "__main__":
    ...
    if args.input:
        if len(args.input) == 1:
            ...
            # smoothing_tracker = Tracker(number_frames=le n(input_list), last_time=2, fps=30)
        ...
        for path in tqdm.tqdm(input_list, disable=not args.output):
            ...
            predictions, visualized_output = demo.run_on_image_smoothing(img, current_idx=idx)
