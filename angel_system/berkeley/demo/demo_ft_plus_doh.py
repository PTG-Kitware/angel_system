...
def get_hand_target_info():
    import pickle
    import numpy as np

    dir = '/shared/niudt/doh_ptg/hand_object_detector/info_result/det.pkl'
...
if __name__ == "__main__":
    hand_target_info = get_hand_target_info()
    ...
    num = 0
    root_dir = '/shared/niudt/doh_ptg/hand_object_detector/Inf_data/Frames/4'
