...
_PREDEFINED_SPLITS_KITWARE_COOKING = {
    "COFFEE": {
        "COFFEE_train": (f"{cooking_data_root}/2022-11-05_whole/ft_file/images", f"{cooking_data_root}/2022-11-05_whole/ft_file/fine-tuning.json"),
        "COFFEE_val": (f"{cooking_data_root}/2022-11-05_whole/ft_file/images", f"{cooking_data_root}/2022-11-05_whole/ft_file/fine-tuning.json"),
    },
}
