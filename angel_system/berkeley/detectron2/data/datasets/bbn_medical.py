...
_PREDEFINED_SPLITS_BBN = {
    "BBN_M2": {
        ...
        "BBN_M2_labels_with_inter_and_before_finished_steps_train": ("", f"{anns_root}/M2_Tourniquet/stage2/m2_with_lab_cleaned_fixed_data_with_inter_and_before_finished_steps/m2_with_lab_cleaned_fixed_data_with_inter_and_before_finished_steps_stage2_train_contact.mscoco.json"),
        "BBN_M2_labels_with_inter_and_before_finished_steps_val": ("", f"{anns_root}/M2_Tourniquet/stage2/m2_with_lab_cleaned_fixed_data_with_inter_and_before_finished_steps/m2_with_lab_cleaned_fixed_data_with_inter_and_before_finished_steps_stage2_val.mscoco.json"),
...
ALL_BBN_CATEGORIES = {
    "BBN_M2": {
        ...
        "BBN_M2_labels_with_inter_and_before_finished_steps":[
            {"id": 1, "name": "tourniquet_tourniquet (step 1)"},{"id": 2, "name": "tourniquet_tourniquet (step 1.5)"},{"id": 3, "name": "tourniquet_tourniquet (step 2)"},{"id": 4, "name": "tourniquet_tourniquet (step 2.5)"},{"id": 5, "name": "tourniquet_tourniquet (step 3)"},{"id": 6, "name": "tourniquet_tourniquet (step 3.5)"},{"id": 7, "name": "tourniquet_tourniquet (step 4)"},{"id": 8, "name": "tourniquet_tourniquet (step 4.5)"},{"id": 9, "name": "tourniquet_tourniquet (step 5)"},{"id": 10, "name": "tourniquet_tourniquet (step 5.5)"},{"id": 11, "name": "tourniquet_tourniquet (step 6)"},{"id": 12, "name": "tourniquet_tourniquet (step 6.5)"},{"id": 13, "name": "tourniquet_tourniquet (step 7)"},{"id": 14, "name": "tourniquet_tourniquet (step 7.5)"},{"id": 15, "name": "tourniquet_tourniquet (step 8)"},{"id": 16, "name": "tourniquet_tourniquet (before)"},{"id": 17, "name": "tourniquet_tourniquet (finished)"},{"id": 18, "name": "tourniquet_label (step 1)"},{"id": 19, "name": "tourniquet_label (step 1.5)"},{"id": 20, "name": "tourniquet_label (step 2)"},{"id": 21, "name": "tourniquet_label (step 2.5)"},{"id": 22, "name": "tourniquet_label (step 3)"},{"id": 23, "name": "tourniquet_label (step 3.5)"},{"id": 24, "name": "tourniquet_label (step 4)"},{"id": 25, "name": "tourniquet_label (step 4.5)"},{"id": 26, "name": "tourniquet_label (step 5)"},{"id": 27, "name": "tourniquet_label (step 5.5)"},{"id": 28, "name": "tourniquet_label (step 6)"},{"id": 29, "name": "tourniquet_label (step 6.5)"},{"id": 30, "name": "tourniquet_label (step 7)"},{"id": 31, "name": "tourniquet_label (step 7.5)"},{"id": 32, "name": "tourniquet_label (step 8)"},{"id": 33, "name": "tourniquet_label (before)"},{"id": 34, "name": "tourniquet_label (finished)"},{"id": 35, "name": "tourniquet_windlass (step 1)"},{"id": 36, "name": "tourniquet_windlass (step 1.5)"},{"id": 37, "name": "tourniquet_windlass (step 2)"},{"id": 38, "name": "tourniquet_windlass (step 2.5)"},{"id": 39, "name": "tourniquet_windlass (step 3)"},{"id": 40, "name": "tourniquet_windlass (step 3.5)"},{"id": 41, "name": "tourniquet_windlass (step 4)"},{"id": 42, "name": "tourniquet_windlass (step 4.5)"},{"id": 43, "name": "tourniquet_windlass (step 5)"},{"id": 44, "name": "tourniquet_windlass (step 5.5)"},{"id": 45, "name": "tourniquet_windlass (step 6)"},{"id": 46, "name": "tourniquet_windlass (step 6.5)"},{"id": 47, "name": "tourniquet_windlass (step 7)"},{"id": 48, "name": "tourniquet_windlass (step 7.5)"},{"id": 49, "name": "tourniquet_windlass (step 8)"},{"id": 50, "name": "tourniquet_windlass (before)"},{"id": 51, "name": "tourniquet_windlass (finished)"},{"id": 52, "name": "tourniquet_pen (step 1)"},{"id": 53, "name": "tourniquet_pen (step 1.5)"},{"id": 54, "name": "tourniquet_pen (step 2)"},{"id": 55, "name": "tourniquet_pen (step 2.5)"},{"id": 56, "name": "tourniquet_pen (step 3)"},{"id": 57, "name": "tourniquet_pen (step 3.5)"},{"id": 58, "name": "tourniquet_pen (step 4)"},{"id": 59, "name": "tourniquet_pen (step 4.5)"},{"id": 60, "name": "tourniquet_pen (step 5)"},{"id": 61, "name": "tourniquet_pen (step 5.5)"},{"id": 62, "name": "tourniquet_pen (step 6)"},{"id": 63, "name": "tourniquet_pen (step 6.5)"},{"id": 64, "name": "tourniquet_pen (step 7)"},{"id": 65, "name": "tourniquet_pen (step 7.5)"},{"id": 66, "name": "tourniquet_pen (step 8)"},{"id": 67, "name": "tourniquet_pen (before)"},{"id": 68, "name": "tourniquet_pen (finished)"},{"id": 69, "name": "hand (step 1)"},{"id": 70, "name": "hand (step 1.5)"},{"id": 71, "name": "hand (step 2)"},{"id": 72, "name": "hand (step 2.5)"},{"id": 73, "name": "hand (step 3)"},{"id": 74, "name": "hand (step 3.5)"},{"id": 75, "name": "hand (step 4)"},{"id": 76, "name": "hand (step 4.5)"},{"id": 77, "name": "hand (step 5)"},{"id": 78, "name": "hand (step 5.5)"},{"id": 79, "name": "hand (step 6)"},{"id": 80, "name": "hand (step 6.5)"},{"id": 81, "name": "hand (step 7)"},{"id": 82, "name": "hand (step 7.5)"},{"id": 83, "name": "hand (step 8)"},{"id": 84, "name": "hand (before)"},{"id": 85, "name": "hand (finished)"}
        ]
        }
}
